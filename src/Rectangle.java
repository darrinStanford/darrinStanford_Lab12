...
public class Rectangle extends Polygon
{
    ...
    public Rectangle(Point center, int width, int height, Color color, boolean filled)
    {
        ...
        location[3] = new Point(center);
        location[2] = new Point(center.x + width, center.y);
        location[1] = new Point(center.x + width, center.y + height);
        location[0] = new Point(center.x, center.y + height);
